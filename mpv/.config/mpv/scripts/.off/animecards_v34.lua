...
local prefix = ""
if os.getenv("HOME") == "/home/afa" then
	prefix = utils.join_path(os.getenv("HOME"), [[.local/share/Anki2/アトア/collecion.media]])
else
	prefix = utils.join_path(os.getenv('APPDATA'), [[Anki2\アトア\collection.media]])
end
...
mp.add_key_binding(nil, "update-anki-card", ex) --ctrl+v
mp.add_key_binding(nil, "toggle-clipboard-insertion", toggle_sub_to_clipboard) --ctrl+t
mp.add_key_binding(nil, "toggle-debug-mode", toggle_debug_mode) --ctrl+d
