...
mp.add_key_binding(nil, "toggle_equalizer",toggle_equalizer)
mp.add_key_binding(nil, "toggle_bindings", toggle_bindings)
mp.add_key_binding(nil, "reset_equalizer", reset_equalizer)
