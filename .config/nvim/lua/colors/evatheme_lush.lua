...
local theme = lush(function()
  return {
    ...
    Directory    { fg = ec.reb_green }, -- Directory names (and other special names in listings)
    ...
    -- fill = { fg=ec.black, bg = ec.black }, -- TODO: add bufferline stuff?
    ...
    String         { fg=ec.orange.da(30) }, --   A string constant: "this is a string"
