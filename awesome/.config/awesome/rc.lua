...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, visible = true, opacity="0.7", height=beautiful.wibox})
...
globalkeys = gears.table.join(
    ...
    -- Layout manipulation
        ...
        --awful.key({modkey}, "o", awful.client.movetoscreen, {description="send client to other screen", group="screen"}),
   ...
   awful.key({ }, "XF86MonBrightnessDown", function ()
    awful.spawn.with_shell("test $(xbacklight -get) -lt 10 && xbacklight -1 || xbacklight -5") end, {description="brightness down", group="media"}),
   awful.key({ }, "XF86MonBrightnessUp", function ()
    awful.spawn.with_shell("test $(xbacklight -get) -lt 10 && xbacklight +1 || xbacklight +5") end, {description="brightness up", group="media"}),

    -- Screenshot
       awful.key({ }, "Print", function ()
        awful.util.spawn("flameshot gui") end, {description="Screenshot", group="media"}),
